module Harvest
  ...
  # [+budget_by+] how the budget is calculated for the project
  #   +project|project_cost|task|person|nil+
  ...
  # [+notify_when_over_budget?+] whether the project will send notifications
  #   when it goes over budget
  # [+over_budget_notification_percentage+] what percentage of the budget
  #   the project has to be before it sends a notification. Based
  #   on +notify_when_over_budget?+
  # [+show_budget_to_all?+] whether the project's budget is shown to employees
  #   and contractors
  # [+basecamp_id+] (READONLY) the id of the basecamp project associated to
  #   the project
  # [+highrise_deal_id+] (READONLY) the id of the highrise deal associated to
  #   the project
  # [+active_task_assignments_count+] (READONLY) the number of active task
  #   assignments
