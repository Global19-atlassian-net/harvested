module Harvest
  module Behavior
    module Crud
      # Retrieves all items
      # @return [Array<Harvest::BaseModel>] an array of models depending on
      #   where you're calling it from (e.g. [Harvest::Client] from
      #   Harvest::Base#clients)
      ...
      # @overload find(model)
      #   @param [Harvest::BaseModel] id you can pass a model and it will
      #     return a refreshed version
      #
      # @return [Harvest::BaseModel] the model depends on where you're calling
      #   it from (e.g. Harvest::Client from Harvest::Base#clients)
      def find(id, user = nil)
        raise "id required" unless id
        response = request(
          :get,
          credentials,
          "#{api_model.api_path}/#{id}",
      ...
      # @return [Harvest::BaseModel] the created model depending on where
      #   you're calling it from (e.g. Harvest::Client from
      #   Harvest::Base#clients)
      ...
      # @overload delete(id)
      #  @param [String] id the String version of the id of the item you want
      #    to delete
      #
