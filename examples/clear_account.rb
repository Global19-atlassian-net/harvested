# This is commented out because it can be very dangerous if run against a
# production account
...
#
# api.reports.time_by_user(
#   my_user,
#   Time.parse('01/01/2000'),
#   Time.now
# ).each do |time|
#   api.time.delete(time)
# end
#
# api.reports.expenses_by_user(
#   my_user,
#   Time.parse('01/01/2000'
# ), Time.now).each do |time|
