...
# Create a Client add a Project to that Client, Add a Task to the Project,
# track some Time against the Project/Task, and then Run a report against all
# time I've submitted
...
entries = harvest.reports.time_by_project(
  project,
  Time.parse("04/11/2010"),
  Time.parse("04/12/2010")
)
puts "Entries:"
entries.each {|e| p e}
